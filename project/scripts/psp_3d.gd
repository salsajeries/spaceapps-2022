...
func _physics_process(delta):
	self.rotate_x(get_node("../wheel_A").get("rotation_offset"))
	self.rotate_y(get_node("../wheel_B").get("rotation_offset"))
	self.rotate_z(get_node("../wheel_C").get("rotation_offset"))
